...
export TODDLER_DEFAULT_MODEL="deepseek-flash"
```
...
`finish_reason="length"` and empty output — raise the effort.  The budget
follows it.  `reasoning_tokens` in the recorded usage shows the reasoning/output
split.
